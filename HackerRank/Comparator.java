...
Output Format
You are not responsible for printing any output to stdout. The locked stub code in Solution
will create a Checker object, use it to sort the Player array, and print each sorted element.
Sample Input:
5
amy 100
david 100
...
class Checker implements Comparator<Player> {
    ...
    public int compare(Player o1, Player o2) {
        if((o2.score-o1.score)==0) return o1.name.compareTo(o2.name);//alphabetically
        else{
